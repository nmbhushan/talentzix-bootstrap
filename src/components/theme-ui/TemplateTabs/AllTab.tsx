    ...
    <div className="grid grid-cols-12 gap-6">
      {TemplateData.map((item, index: any) => (
          <div key={index} className="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 group overflow-hidden relative">
            ...
            <Link href="/resume-templates/build-resume" className="block py-3 bg-primary text-primary-foreground shadow hover:bg-primary-hover hover:text-primary-foregroundHover hidden group-hover:block rounded-[70px] px-5 absolute top-[80%] z-10 left-0 right-0 mx-auto w-auto max-w-[137px]">Use Template</Link>
          </div>
      ))}
    </div>
  );
