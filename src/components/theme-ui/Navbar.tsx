...
export const Navbar = () => {
  ...
  return (
    <div className="bg-[#F6F5FD]">
      <header className="sticky h-[82px] flex items-center rounded-b-3xl top-0 z-40 w-full bg-gradient-to-b from-[#EDF6FF] to-[#F5E3FC]">
            ...
            <span className="flex md:hidden">
              ...
              >
                <SheetTrigger className="px-2">
                  <Menu
                    className="flex md:hidden h-5 w-5 text-[#000000]"
