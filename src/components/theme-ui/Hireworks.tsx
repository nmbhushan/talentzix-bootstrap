                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="col-span-12 md:col-span-6">
                        <div className="border border-[#E9E9E9] rounded-[12px] p-5 relative">
                            <Image className="absolute right-3" src="https://resumegenie.s3.ap-south-1.amazonaws.com/landing/step-1.webp" alt="Image" width="40" height="40" />
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <div className="border border-[#E9E9E9] rounded-[12px] p-5 relative">
                            <Image className="absolute right-3" src="https://resumegenie.s3.ap-south-1.amazonaws.com/landing/step-2.webp" alt="Image" width="40" height="40" />
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <div className="border border-[#E9E9E9] rounded-[12px] p-5 relative">
                            <Image className="absolute right-3" src="https://resumegenie.s3.ap-south-1.amazonaws.com/landing/step-3.webp" alt="Image" width="40" height="40" />
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <div className="border border-[#E9E9E9] rounded-[12px] p-5 relative">
                            <Image className="absolute right-3" src="https://resumegenie.s3.ap-south-1.amazonaws.com/landing/step-4.webp" alt="Image" width="40" height="40" />
